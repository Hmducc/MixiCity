  ...
  return (
    <div className="h-screen    text-white flex flex-col">
      ...
      <div className="flex flex-1 gap-4 px-6 py-6 background ">
        {/* City Section */}
        <div className="flex-1   bg-gray-100 text-gray-900 p-6 rounded-lg shadow-lg flex flex-col justify-center items-center">
          <div>
            <img src={logo} className="h-[100px] w-[200px]"></img>
          </div>
        ...
        <div className="w-1/3 flex flex-col gap-4 ">
          {/* News Section */}
          <div className="bg-gray-300 text-gray-900 p-4 rounded-lg shadow-lg flex-1">
            <h3 className="text-xl font-bold mb-4">News Section</h3>
            <button className="group relative inline-block avenir">
              <div className="px-4 py-2 rounded flex justify-center items-center gap-2  group-hover:bg-[#e2b573] transition-colors duration-300">
                <svg
                  className="h-[20px] w-[20px] fill-[#e2b573] group-hover:fill-[#bf1f26] transition-colors duration-300"
                  width="800px"
                  height="800px"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-[#e2b573] group-hover:text-[#bf1f26] font-bold transition-colors duration-300">
                  Discord Mixigaming
                </span>
              </div>
            </button>
          ...
          {/* Banner Section */}
          <div className="bg-blue-700 p-6 h-52 rounded-lg shadow-lg">
